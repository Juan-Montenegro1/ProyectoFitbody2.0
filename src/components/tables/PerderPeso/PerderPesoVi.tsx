...
const ejerciciosPerderPesoViernes = [
  {
  ...
  {
    nombre: "Plancha lateral (Alterna lado)",
    imagen: "/images/logo/fitbodyblack.png",
...
export default function RutinaPerderPesoViernes() {
  return (
    <ComponentCard title="Viernes (Cardio + Core)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosPerderPesoViernes.map((ejer, index) => (
          <div
            key={index}
