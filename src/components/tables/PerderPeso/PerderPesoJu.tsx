...
const ejerciciosPerderPesoJueves = [
  {
...
export default function RutinaPerderPesoJueves() {
  return (
    <ComponentCard title="Jueves (HIIT + Piernas)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosPerderPesoJueves.map((ejer, index) => (
          <div
            key={index}
