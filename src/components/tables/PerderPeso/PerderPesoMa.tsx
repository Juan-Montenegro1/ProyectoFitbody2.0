...
const ejerciciosPerderPesoMartes = [
  {
...
export default function RutinaPerderPesoMartes() {
  return (
    <ComponentCard title="Martes (Cardio LISS)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosPerderPesoMartes.map((ejer, index) => (
          <div
            key={index}
