...
const ejerciciosPerderPesoLunes = [
  {
    nombre: "Burpees",
...
export default function RutinaPerderPesoLunes() {
  return (
    <ComponentCard title="Lunes (HIIT + Core)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosPerderPesoLunes.map((ejer, index) => (
          <div
            key={index}
