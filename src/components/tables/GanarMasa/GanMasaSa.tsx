...
const ejerciciosGanarMasaSabado = [
  {
...
export default function RutinaGanarMasaSabado() {
  return (
    <ComponentCard title="Sabado (Cardio suave)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosGanarMasaSabado.map((ejer, index) => (
          <div
            key={index}
