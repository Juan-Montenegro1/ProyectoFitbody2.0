...
const ejerciciosGanarMasaJueves = [
  {
    nombre: "Press militar",
    imagen: "/images/logo/fitbodyblack.png",
    Equipo: "Barra olímpica / Mancuernas",
...
export default function RutinaGanarMasaJueves() {
  return (
    <ComponentCard title="Jueves (Hombros + Trapecios)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosGanarMasaJueves.map((ejer, index) => (
          <div
            key={index}
