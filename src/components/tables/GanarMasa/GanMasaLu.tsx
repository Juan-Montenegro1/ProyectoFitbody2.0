...
const ejerciciosGanarMasaLunes = [
  {
...
export default function RutinaGanarMasaLunes() {
  return (
    <ComponentCard title="Lunes (Pecho + Tríceps)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosGanarMasaLunes.map((ejer, index) => (
          <div
            key={index}
