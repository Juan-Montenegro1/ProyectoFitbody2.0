...
const ejerciciosGanarMasaMartes = [
  {
...
export default function RutinaGanarMasaMartes() {
  return (
    <ComponentCard title="Martes (Espalda + Bíceps)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosGanarMasaMartes.map((ejer, index) => (
          <div
            key={index}
