...
const ejerciciosGanarMasaMiercoles = [
  {
...
export default function RutinaGanrMasaMiercoles() {
  return (
    <ComponentCard title="Miercoles (Piernas + Core)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosGanarMasaMiercoles.map((ejer, index) => (
          <div
            key={index}
