...
const ejerciciosGanarMasaViernes = [
  {
    nombre: "Sentadilla búlgara",
    imagen: "/images/logo/fitbodyblack.png",
    Equipo: "Peso corporal / Mancuernas",
...
export default function RutinaGanarMasaViernes() {
  return (
    <ComponentCard title="Viernes (Full Body Fuerza)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosGanarMasaViernes.map((ejer, index) => (
          <div
            key={index}
