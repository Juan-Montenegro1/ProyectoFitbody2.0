...
const ejerciciosMantenerFormaSabado = [
  {
    nombre: "Natación",
  ...
  {
    nombre: "Deportes recreativos (fútbol, baloncesto, etc.)",
    imagen: "/images/logo/fitbodyblack.png",
    Equipo: "N/A",
    Dificultad: "Todos",
  },
...
export default function RutinaMantenerFormaSabado() {
  return (
    <ComponentCard title="Sabado (Recreativo)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosMantenerFormaSabado.map((ejer, index) => (
          <div
            key={index}
