...
const ejerciciosMantenerFormaJueves = [
  {
  ...
  {
    nombre: "Planchas con toque de hombro",
    imagen: "/images/logo/fitbodyblack.png",
...
export default function RutinaMantenerFormaJueves() {
  return (
    <ComponentCard title="Jueves (Brazo + Abdomen)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosMantenerFormaJueves.map((ejer, index) => (
          <div
            key={index}
