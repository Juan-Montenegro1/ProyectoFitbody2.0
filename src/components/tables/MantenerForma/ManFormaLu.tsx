...
const ejerciciosMantenerFormaLunes = [
  {
    nombre: "Sentadillas",
...
export default function RutinaMantenerFormaLunes() {
  return (
    <ComponentCard title="Lunes (Full Body)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosMantenerFormaLunes.map((ejer, index) => (
          <div
            key={index}
