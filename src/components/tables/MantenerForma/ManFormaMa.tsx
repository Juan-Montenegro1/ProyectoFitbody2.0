...
const ejerciciosMantenerFormaMartes = [
  {
...
export default function RutinaMantenerFormaMartes() {
  return (
    <ComponentCard title="Martes (Cardio + Core)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosMantenerFormaMartes.map((ejer, index) => (
          <div
            key={index}
