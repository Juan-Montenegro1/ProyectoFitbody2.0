...
const ejerciciosMantenerFormaMiercoles = [
  {
...
export default function RutinaMantenerFormaMiercoles() {
  return (
    <ComponentCard title="Miercoles (Funcional / Movilidad)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosMantenerFormaMiercoles.map((ejer, index) => (
          <div
            key={index}
