...
export default function RutinaMantenerFormaViernes() {
  return (
    <ComponentCard title="Viernes (´Pierna + Cardio)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosMantenerFormaViernes.map((ejer, index) => (
          <div
            key={index}
