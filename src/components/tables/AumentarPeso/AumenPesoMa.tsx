...
const ejerciciosAumentarPesoMartes = [
  {
    nombre: "Natación Ligera",
...
export default function RutinaAumentarPesoMartes() {
  return (
    <ComponentCard title="Martes (Descanso Activo)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosAumentarPesoMartes.map((ejer, index) => (
          <div
            key={index}
