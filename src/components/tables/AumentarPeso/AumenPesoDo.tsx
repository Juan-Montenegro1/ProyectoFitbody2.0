...
const ejerciciosAumentarPesoDomingo = [
  {
...
export default function RutinaAumentarPesoDomingo() {
  return (
    <ComponentCard title="Domingo (Descanso)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosAumentarPesoDomingo.map((ejer, index) => (
          <div
            key={index}
