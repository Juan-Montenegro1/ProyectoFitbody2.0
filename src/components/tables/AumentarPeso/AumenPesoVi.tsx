...
const ejerciciosAumentarPesoViernes = [
  {
    nombre: "Caminata rapida / Bicicleta",
...
export default function RutinaAumentarPesoViernes() {
  return (
    <ComponentCard title="Viernes (Cardio suave)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosAumentarPesoViernes.map((ejer, index) => (
          <div
            key={index}
