...
const ejerciciosAumentarPesoJueves = [
  {
...
export default function RutinaAumentarPesoJueves() {
  return (
    <ComponentCard title="Jueves (Pierna + Abdomen)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosAumentarPesoJueves.map((ejer, index) => (
          <div
            key={index}
