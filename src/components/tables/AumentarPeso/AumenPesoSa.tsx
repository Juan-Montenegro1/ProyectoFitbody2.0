...
const ejerciciosAumentarPesoSabado = [
  {
    nombre: "Circuito de Crossfit", 
    imagen: "/images/logo/fitbodyblack.png",
    Equipo: " Peso corporal / Barra / Mancuernas",
    Dificultad: "Principiante",
  },
];

export default function RutinaAmentarPesoSabado() {
  return (
    <ComponentCard title="Sabado (Crossfit)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosAumentarPesoSabado.map((ejer, index) => (
          <div
            key={index}
