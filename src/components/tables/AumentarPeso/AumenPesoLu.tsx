...
const ejerciciosAumentarPesoLunes = [
  {
    nombre: "Sentadillas",
...
export default function RutinaAumentarPesoLunes() {
  return (
    <ComponentCard title="Lunes (Full Body Fuerza)">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {ejerciciosAumentarPesoLunes.map((ejer, index) => (
          <div
            key={index}
